...
document.addEventListener("DOMContentLoaded", function(){
  ...
  SUB_TITLE.innerHTML = "DEV - ALEXANDRE";
  ...
  const URL_PHOTO = [
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTd3RMAY16R6R77zTeBcucspFtqbrdxYxnjCWYEBpMzgA&s=10",
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTyd-ONAmmyIB5fpVyinqu5JA4XRrnCEhUOpwXWUKkm7w&s=10"
  ];

  function BROWSER_IMG(src, x, y){
    const photo = new Image();
    photo.src = src;
    photo.onload = () => {
      CX.drawImage(photo, x, y, CS.height, CS.width);
    };
  };

  BROWSER_IMG(URL_PHOTO[0], 0, 0);
  BROWSER_IMG(URL_PHOTO[1], 100, 40);
